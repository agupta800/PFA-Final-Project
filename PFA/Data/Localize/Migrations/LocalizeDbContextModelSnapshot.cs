...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PFA.Data.Localize.Domain", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PFA.Data.Localize.Key", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PFA.Data.Localize.KeyValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PFA.Data.Localize.Query", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PFA.Data.Localize.Key", b =>
                {
                    b.HasOne("PFA.Data.Localize.Domain", "Domain")
                        .WithMany("Keys")
            ...
            modelBuilder.Entity("PFA.Data.Localize.KeyValue", b =>
                {
                    b.HasOne("PFA.Data.Localize.Key", "Key")
                        .WithMany("Values")
                        .HasForeignKey("KeyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
